  ...
  return (
    <Sheet>
      ...
      <SheetContent side='left' className='w-[85%] p-6'>
        ...
        {/* HOME */}
        <SheetClose asChild>
          <Link href={`/`} className={`block text-lg ${isActive('/') ? 'text-red!' : 'text-gray-800'}`}>
            Home
          </Link>
        </SheetClose>
        ...
        <div className=' space-y-6'>
          ...
          {/* CATALOG */}
          <SheetClose asChild>
            <Link href={`/catalog`} className={`block text-lg ${isActive('/catalog') ? 'text-red' : 'text-gray-800'}`}>
              {t('nav.catalog')}
            </Link>
          </SheetClose>
          ...
          {/* ABOUT */}
          <SheetClose asChild>
            <Link href={`/about`} className={`block text-lg ${isActive('/about') ? 'text-red' : 'text-gray-800'}`}>
              {t('nav.about')}
            </Link>
          </SheetClose>
