  ...
  const collections = [
    {
      ...
      color: "#581010",
      img: "1.webp",
      slug: "/collections/shine-glossy",
    },
    {
      title: t("classicMarbles"),
      color: "#282828",
      img: "2.webp",
      slug: "/collections/classic-marbles",
    },
    {
      title: t("stonesMixes"),
      color: "#282828",
      img: "3.webp",
      slug: "/collections/stones-mixes",
    },
    {
      title: t("other"),
      color: "#581010",
    ...
    },
    {
      ...
      color: "#282828",
      img: "5.webp",
      slug: "/collections/wood-tiles",
    },
    {
      title: t("modernPatterns"),
      color: "#282828",
      img: "8.webp",
      slug: "/collections/shine-glossy",
    },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
        {collections.map((item, idx) => (
          <Link
            key={idx}
            href={item.slug}
            className="border-2 border-[#DDDDDD] overflow-hidden hover:opacity-90 transition"
          >
